...
class Init {
  public:
	Init() {
		rainbow.push_back(std::make_pair<tColor, double>(magenta, 0.01));
		rainbow.push_back(std::make_pair<tColor, double>(blue, 0.20));
		rainbow.push_back(std::make_pair<tColor, double>(cyan, 0.35));
		rainbow.push_back(std::make_pair<tColor, double>(green, 0.50));
		rainbow.push_back(std::make_pair<tColor, double>(yellow, 0.65));
		rainbow.push_back(std::make_pair<tColor, double>(red, 0.97));

		blackwhite.push_back(std::make_pair<tColor, double>(white, -0.75));
		blackwhite.push_back(std::make_pair<tColor, double>(gray, 0.41));
		blackwhite.push_back(std::make_pair<tColor, double>(black, 1.23));
	}
};
